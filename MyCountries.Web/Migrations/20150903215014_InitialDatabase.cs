        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Duration = table.Column<int>(isNullable: false),
                    FirstVisit = table.Column<bool>(isNullable: false),
                    ForFun = table.Column<bool>(isNullable: false),
                    ForWork = table.Column<bool>(isNullable: false),
                    Notes = table.Column<string>(isNullable: true),
                    UserName = table.Column<string>(isNullable: true),
                    VisitDate = table.Column<DateTime>(isNullable: false)
                },
                constraints: table =>
                {
